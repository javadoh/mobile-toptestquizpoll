 ...
 */
public class ReporteExamenesNubeSubmitted implements Serializable{
    ...
    private ArrayList<ReporteExamenesNubeDatos> datosPrueba;
    ...
    public ArrayList<ReporteExamenesNubeDatos> getDatosPrueba() {
        if(datosPrueba == null){
    ...
    public void setDatosPrueba(ArrayList<ReporteExamenesNubeDatos> datosPrueba) {
